...
public class UserResource {
    ...
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('USER_RESOURCE', 'CREATE')")
    ...
    @Timed
    @Transactional
    @PreAuthorize("@jhiAuth.hasPermission('USER_RESOURCE', 'EDIT')")
    ...
    @PreAuthorize("@jhiAuth.hasPermission('USER_RESOURCE', 'VIEW')")
    ...
    @RequestMapping(value = "/users/{login:[_'.@a-z0-9-]+}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    @PreAuthorize("@jhiAuth.hasPermission('USER_RESOURCE', 'DELETE')")
